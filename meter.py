        ...
        if self.meter_type == TYPE_LINEAR:
            ...
            if self.channels == 2:
                self.left = CircularAnimator(
                    ...
                    self.meter_parameters[LEFT_ORIGIN_X],
                    self.meter_parameters[LEFT_ORIGIN_Y],
                )
                self.right = CircularAnimator(
                    self.data_source,
                    self.components[2],
                    self,
                    self.meter_parameters,
                ...
                self.mono = CircularAnimator(
                    ...
                    self.meter_parameters[MONO_ORIGIN_X],
                    self.meter_parameters[MONO_ORIGIN_Y],
                )
                self.mono.start()
